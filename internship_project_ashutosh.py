...
def prerprocess(pth):
   ...
   # print(workabledata)
    ...
    thrword=[('',''),('left','pleural_fluid'),('bilateral_cp','_angle'),('right','pleural_fluid'),('left','pleural_cavity'),('right','pleural_cavity'),('right','cp_angle'),('left','cp_angle'),('left', 'upper_lobe'),('right', 'upper_lobe'),('right','pleural_effusion'),('bilateral', 'pleural_effusion'),('left', 'pleural_effusion')]
    ...
    thrword=[('left','pleural_cavity'),('right','pleural_cavity'),('bilateral','cp_angle'),('right','cp_angle'),('left','cp_angle'),('right','pleural_effusion'),('bilateral', 'pleural_effusion'),('left', 'pleural_effusion')]
    ...
    commonevidencesuggestive=['suggestive','obscured','acute','blunting','blunted','haze','there_is','present','minimal','present','seen','hazy','due to','s/o','mild','evidence','noted','?','??','suggest']
    wordsrelatedtope=['right lower zone','left lower zone','left_pleural_effusion,left_pleural_fluid','right_pleural_effusion','right_pleural_fluid','pleural_effusion','bilateral_cp','bilateral_cp_angle','free_fluid','cp_angle_free_fluid','bilateral_pleural_effusion','left_pleural_effusion','right_pleural_effusion','bilateral_pleural_effusion','cp_angle','left_cp_angle','right_cp_angle','pleural_cavity','left_pleural_cavity','right_pleural_cavity','subpulmonic_effusion','effusion','bilateral_cp__angle']
...
print(metrics.classification_report(y_test, ospdo))
##Computing false and true positive rates
fpr, tpr,_=roc_curve(y_test,ospdo,drop_intermediate=False)
...
plt.title('ROC curve')
plt.show()
print("AUC SCORE",roc_auc_score(y_test,ospdo))
print("-----------------")
...
print("Specificity:",specificity)
print("Sensitivity:",sensitivity)
print(metrics.classification_report(y_train, ospdo))
##Computing false and true positive rates
fpr, tpr,_=roc_curve(y_train,ospdo,drop_intermediate=False)
...
plt.title('ROC curve')
plt.show()
print("AUC SCORE",roc_auc_score(y_train,ospdo))
...
#print("Sensitivity:",sensitivity)
#print(metrics.classification_report(y_test, ospdo))
#print(training_stuff.Result[45])
